...
export function ProjectCard({ title, url, screenshot, index }: ProjectCardProps) {
    return (
        <motion.div
            ...
            className="group relative overflow-hidden rounded-2xl bg-card border border-primary/10 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
        >
            {/* Image Container */}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 z-30 flex items-center justify-center">
                    ...
                    >
                        <Link
                            ...
                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-card text-primary rounded-full font-semibold text-sm shadow-lg hover:bg-primary hover:text-white transition-all duration-300"
                        >
